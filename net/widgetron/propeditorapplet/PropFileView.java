...
public class PropFileView extends JFrame{
	...
	static private String pFileName = "build.trout.prop";
	...
	private JButton jbSaveSession;
	private JButton jbOpenSession;
	...
	public void mainScreen(){
		...
		jbOpenSession = new JButton("Open Editing Session");
		...
		c.gridwidth = 8;
                ...
                c.gridx = 0;
                c.gridy = 0;
                G1graphics g1 = new G1graphics(0,0,270,210);
                jpMain.add(g1, c);
		...
		jbOpenSession.addActionListener(oH);
	...
	public void editorScreen(String propList[]){
		...
		jbSaveSession = new JButton ("Save Session");
		...
		jbSaveSession.addActionListener(sH);
	...
	class SaveHandler implements ActionListener{
		public void actionPerformed(ActionEvent e) {
			...
			}else if( e.getSource() == jbSaveSession ){
				int returnVal = myFileChooser.showSaveDialog(jpEdit);
				if (returnVal == JFileChooser.APPROVE_OPTION){
					File newFile = myFileChooser.getSelectedFile();
					pFileName = newFile.getAbsolutePath();
					pE.saveSession(pFileName);
				}
			}
	...
	pE = new PropEditor(pFileName, sFileName);
						...
						JOptionPane.showMessageDialog(jpMain, "Filename chosen not readable");
					}
				}
			}
		}
